...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'exoscale', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-exoscale',
    version=ABOUT['__version__'],
    description='The Exoscale check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent exoscale check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Robert Coleman',
    author_email='datadog@robert.net.nz',
    # License
    ...
    packages=['datadog_checks.exoscale'],
